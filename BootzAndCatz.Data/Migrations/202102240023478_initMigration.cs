    ...
    public partial class initMigration : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        ShelterName = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => new { t.CatId, t.PetId })
                .ForeignKey("dbo.Shelter", t => t.ShelterName)
                .Index(t => t.ShelterName);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.DogId, t.PetId })
                .ForeignKey("dbo.Shelter", t => t.ShelterName)
                .Index(t => t.ShelterName);
